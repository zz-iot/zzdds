...
pub const takeWithReadConditionRaw = raw_ops.takeWithReadConditionRaw;
pub const readWithReadConditionRaw = raw_ops.readWithReadConditionRaw;
pub const takeNextInstanceWithReadConditionRaw = raw_ops.takeNextInstanceWithReadConditionRaw;
pub const readNextInstanceWithReadConditionRaw = raw_ops.readNextInstanceWithReadConditionRaw;
