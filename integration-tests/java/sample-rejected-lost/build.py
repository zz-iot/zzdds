#!/usr/bin/env python3
"""Builds the zzdds Java sample-rejected-lost integration test.
...
def main() -> int:
    ...
    print("Generating StatusEvent TypeSupport/DataWriter/DataReader from idl/status_event.idl...")
    ...
    if not run_build(
        [
            ...
            "-o", str(GENERATED_DIR),
            str(SCRIPT_DIR / "idl" / "status_event.idl"),
        ],
        cwd=SCRIPT_DIR,
