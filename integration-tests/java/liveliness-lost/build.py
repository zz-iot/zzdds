#!/usr/bin/env python3
"""Builds the zzdds Java liveliness-lost integration test.
...
def main() -> int:
    ...
    print("Generating LivelinessEvent TypeSupport/DataWriter/DataReader from idl/liveliness_event.idl...")
    ...
    if not run_build(
        [
            ...
            "-o", str(GENERATED_DIR),
            str(SCRIPT_DIR / "idl" / "liveliness_event.idl"),
        ],
        cwd=SCRIPT_DIR,
