#!/usr/bin/env python3
"""Builds the zzdds Java source-timestamp integration test.
...
def main() -> int:
    ...
    print("Generating TimestampEvent TypeSupport/DataWriter/DataReader from idl/timestamp_event.idl...")
    ...
    if not run_build(
        [
            ...
            "-o", str(GENERATED_DIR),
            str(SCRIPT_DIR / "idl" / "timestamp_event.idl"),
        ],
        cwd=SCRIPT_DIR,
