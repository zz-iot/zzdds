#!/usr/bin/env python3
"""Builds the zzdds Java cft-reconfigure integration test.
...
def main() -> int:
    ...
    print("Generating CftEvent TypeSupport/DataWriter/DataReader from idl/cft_event.idl...")
    ...
    if not run_build(
        [
            ...
            "-o", str(GENERATED_DIR),
            str(SCRIPT_DIR / "idl" / "cft_event.idl"),
        ],
        cwd=SCRIPT_DIR,
