#!/usr/bin/env python3
"""Builds the zzdds Java coherent-sets integration test.
...
def main() -> int:
    ...
    print("Generating Position/Velocity TypeSupport/DataWriter/DataReader from idl/pose_group.idl...")
    ...
    if not run_build(
        [
            ...
            "-o", str(GENERATED_DIR),
            str(SCRIPT_DIR / "idl" / "pose_group.idl"),
        ],
        cwd=SCRIPT_DIR,
