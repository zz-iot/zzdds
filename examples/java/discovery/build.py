#!/usr/bin/env python3
"""Builds the zzdds Java discovery example.
...
def main() -> int:
    ...
    print("Generating DiscoveryPing TypeSupport/DataWriter/DataReader from idl/discovery_ping.idl...")
    ...
    if not run_build(
        [
            ...
            "-o", str(GENERATED_DIR),
            str(SCRIPT_DIR / "idl" / "discovery_ping.idl"),
        ],
        cwd=SCRIPT_DIR,
