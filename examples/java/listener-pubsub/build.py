...
def main() -> int:
    ...
    zidl_exe = zig_out / "bin" / ("zidl.exe" if sys.platform == "win32" else "zidl")
    ...
    print("Generating SensorSample TypeSupport/DataWriter/DataReader from idl/sensor.idl...")
