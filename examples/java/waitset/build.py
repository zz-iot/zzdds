#!/usr/bin/env python3
"""Builds the zzdds Java waitset example.
...
def main() -> int:
    ...
    print("Generating WaitsetSample TypeSupport/DataWriter/DataReader from idl/waitset_sample.idl...")
    ...
    if not run_build(
        [
            ...
            "-o", str(GENERATED_DIR),
            str(SCRIPT_DIR / "idl" / "waitset_sample.idl"),
        ],
        cwd=SCRIPT_DIR,
