#!/usr/bin/env python3
"""Builds the zzdds Java catchup example.
...
def main() -> int:
    ...
    print("Generating HistoryEvent TypeSupport/DataWriter/DataReader from idl/catchup_sample.idl...")
    ...
    if not run_build(
        [
            ...
            "-o", str(GENERATED_DIR),
            str(SCRIPT_DIR / "idl" / "catchup_sample.idl"),
        ],
        cwd=SCRIPT_DIR,
