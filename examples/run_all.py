...
def main() -> int:
    ...
    # ── raw-loan cross-binding interop (needs c, cpp, and java; zig is native) ──
    if c_binding and cpp_binding and java_binding:
        run_section("interop/raw-loan-cross-binding", lambda: run_script(SCRIPT_DIR / "interop" / "raw_loan_cross_binding_smoke_test.py", env=env))
    else:
