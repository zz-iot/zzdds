...
const Harness = struct {
    ...
    fn makeReader(self: *@This()) !*DataReaderImpl {
        ...
        dr.* = .{
            ...
            .qos = .{},
            .listener_box = try zzdds.util.listener_box.ListenerBox(DDS.DataReaderListener).create(self.alloc, dcps.nil_dr_listener),
            .listener_mask = 0,
    ...
    fn registerGetFieldRefresh(_: *anyopaque, _: DDS.InstanceHandle_t, _: []const u8, _: *anyopaque, _: *const fn (*anyopaque, ?filter_mod.CdrFieldGetter) void) ?filter_mod.CdrFieldGetter {
