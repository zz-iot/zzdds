#!/usr/bin/env bash
# Builds the zzdds Java pub/sub example.
#
# Prerequisites:
...
echo "Generating SensorSample TypeSupport/DataWriter/DataReader from idl/sensor.idl..."
rm -rf "$GENERATED_DIR"
mkdir -p "$GENERATED_DIR"
"$ZZDDS_ZIG_OUT/bin/zidl" -b java --generate-zzdds-wrappers --java-import-package "DDS=io.zzdds.dcps" -o "$GENERATED_DIR" "$SCRIPT_DIR/idl/sensor.idl"
